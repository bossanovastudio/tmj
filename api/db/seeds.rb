User.create({ username: 'ramona', password: '123456', role: :editor, name: 'Ramona', remote_image_url: 'https://s3-sa-east-1.amazonaws.com/cdntmjofilme/avatars/1/ramona.png' })
